...
export function FlightsTableData() {
  ...
  const flightFields: FormField[] = useMemo(() => [
    { name: "airline_id", label: "Maskapai", type: "select", required: true, options: airlineOptions },
    { name: "flight_number", label: "Nomor Penerbangan", required: true },
    { name: "origin_id", label: "Asal", type: "select", required: true, options: airportOptions },
    { name: "destination_id", label: "Tujuan", type: "select", required: true, options: airportOptions },
    ...
    { name: "total_rows", label: "Baris", type: "number", required: true },
    { name: "total_columns", label: "Kolom", type: "number", required: true },
    {
      name: "class_prices",
  ...
  if (isLoading) return <p className="p-4 text-center text-muted-foreground animate-pulse">Memuat data penerbangan...</p>
